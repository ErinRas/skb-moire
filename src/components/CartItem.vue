<template>
  <li class="cart__item product">
    <div class="product__pic">
      <img :src="img !== null ? img : 'assets/no-image.jpg'" width="120" height="120" :alt="title" />
    </div>
...
export default {
  ...
  computed: {
    pricePretty() {
      return numberFormat(this.price * this.productAmount)
    },
    productAmount: {
      get() {
        return this.amount
